 ...
 *
 * Modified for MTK Helio G90T - Kernel 4.14
 *
...
/* MTK-specific includes - only if available */
#ifdef CONFIG_MTK_CPU_FREQ
#include <mtk_cpufreq.h>
#endif

/* Compatibility layer for boosted_cpu_util */
...
static inline unsigned long boosted_cpu_util(int cpu)
{
	...
	/* Simple boost logic if schedtune not available */
